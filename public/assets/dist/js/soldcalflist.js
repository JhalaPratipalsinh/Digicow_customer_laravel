$('#sold-calf-list').DataTable({
    'processing': true,
    'serverSide': true,
    'serverMethod': 'post',
    "ajax": {
        type: "POST",
        url: BASE_URL + '/calfs/sold-paginate',
        headers: {
...

    {
        render: function (data, type, row) {
            ...
            <a href="`+ BASE_URL + `/calfs/sold-remove/` + row.id + `" class="btn btn-sm btn-danger" title="Remove" onclick="return confirm('Are you sure?')">
