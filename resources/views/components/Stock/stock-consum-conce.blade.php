...
@section('contents')
    ...
    @php
        ...
        $breadcrumb .= '<li class="breadcrumb-item"><a href="">Add Feed Stock Concentrates</a></li>';
        $breadcrumb .= '<li class="breadcrumb-item active">Create</li>';
    @endphp
    <x-backend-breadcrumb title="Add Feed Stock Concentrates" breadcrumb="{{ $breadcrumb }}" />
    <!-- /.content-header -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- .card-body -->
                        {{ Form::open(['url' => URL::to('feed/stock-store'), 'files' => true, 'class' => 'multiple-form-submit']) }}
