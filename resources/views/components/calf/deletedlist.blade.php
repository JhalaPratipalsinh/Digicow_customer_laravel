...
$breadcrumb .= '<li class="breadcrumb-item active">Calf List</li>';
@endphp
<x-backend-breadcrumb title="Calf List" breadcrumb="{{$breadcrumb}}" />
<!-- /.content-header -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="calf-delete-list" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Calf Name</th>
                                    <th>Breed</th>
...
@section('scripts')
<script src="{{ asset('assets/dist/js/calfdelete.js') }}"></script>
@endsection
