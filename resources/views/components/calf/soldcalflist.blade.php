...
$breadcrumb .= '<li class="breadcrumb-item active">Sold Cows List</li>';
@endphp
<x-backend-breadcrumb title="Sold Cows List" breadcrumb="{{$breadcrumb}}" />
<!-- /.content-header -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="sold-calf-list" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Cow Name</th>
                                    <th>Buyer s Name</th>
...
@section('scripts')
<script src="{{ asset('assets/dist/js/soldcalflist.js') }}"></script>
@endsection
