...
@section('contents')
    ...
    @php
        ...
        $breadcrumb .= '<li class="breadcrumb-item"><a href="">Add calf to sold</a></li>';
        $breadcrumb .= '<li class="breadcrumb-item active">Create</li>';
    @endphp
    <x-backend-breadcrumb title="Add calf to sold" breadcrumb="{{ $breadcrumb }}" />
    <!-- /.content-header -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- .card-body -->
                        {{ Form::open(['url' => URL::to('calfs/sold-store'), 'files' => true, 'class' => 'multiple-form-submit']) }}
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="Select Date"
                                            name="sales_date" value="{{ old('sales_date') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Buyer's Name"
                                            name="buyer_name" value="{{ old('buyer_name') }}">
                                    </div>
                                </div>
                            </div>
