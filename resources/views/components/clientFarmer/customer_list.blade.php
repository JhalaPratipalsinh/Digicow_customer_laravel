...
@section('contents')
    ...
    @php
        ...
        $breadcrumb .= '<li class="breadcrumb-item active">Consumption Feeding List</li>';
    @endphp
    <x-backend-breadcrumb title="Consumption Feeding List" breadcrumb="{{ $breadcrumb }}" />
    <!-- /.content-header -->
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="farmer-customer-list" class="table table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>Customer Name</th>
                                        <th>Mobile</th>
...
@section('scripts')
    <script src="{{ asset('assets/dist/js/farmercustomer.js') }}"></script>
@endsection
