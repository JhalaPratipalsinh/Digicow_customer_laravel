...
@section('contents')
    ...
    @php
        ...
        $breadcrumb .= '<li class="breadcrumb-item"><a href="">Record Dead Cow</a></li>';
        $breadcrumb .= '<li class="breadcrumb-item active">Create</li>';
    @endphp
    <x-backend-breadcrumb title="Record Dead Cow" breadcrumb="{{ $breadcrumb }}" />
    <!-- /.content-header -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- .card-body -->
                        {{ Form::open(['url' => URL::to('cow/dead-store'), 'files' => true, 'class' => 'multiple-form-submit']) }}
