...
$breadcrumb .= '<li class="breadcrumb-item active">Dewormer List</li>';
@endphp
<x-backend-breadcrumb title="Dewormer List" breadcrumb="{{$breadcrumb}}" />
<!-- /.content-header -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="dewormer-list" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Cow Name</th>
                                    <th>De-wormer</th>
...
<script src="{{ asset('assets/dist/js/dewormer.js') }}"></script>
@endsection
