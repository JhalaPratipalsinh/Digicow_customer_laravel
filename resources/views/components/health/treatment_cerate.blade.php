...
$breadcrumb .= '<li class="breadcrumb-item"><a href="">Record New Health Record</a></li>';
$breadcrumb .= '<li class="breadcrumb-item active">Create</li>';
@endphp
<x-backend-breadcrumb title="Record New Health Record" breadcrumb="{{ $breadcrumb }}" />
<!-- /.content-header -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- .card-body -->
                    {{ Form::open(['url' => URL::to('health-record/treatment-store'), 'files' => true, 'class' => 'multiple-form-submit']) }}
