...
$breadcrumb .= '<li class="breadcrumb-item active">Treatment List</li>';
@endphp
<x-backend-breadcrumb title="Treatment List" breadcrumb="{{$breadcrumb}}" />
<!-- /.content-header -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="treatment-list" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Cow Name</th>
                                    <th>Treatment</th>
...
<script src="{{ asset('assets/dist/js/treatment.js') }}"></script>
@endsection
