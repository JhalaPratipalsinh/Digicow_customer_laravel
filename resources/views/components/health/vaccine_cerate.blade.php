...
$breadcrumb .= '<li class="breadcrumb-item"><a href=""> Record New Health Vaccine Record</a></li>';
$breadcrumb .= '<li class="breadcrumb-item active">Create</li>';
@endphp
<x-backend-breadcrumb title=" Record New Health Vaccine Record" breadcrumb="{{ $breadcrumb }}" />
<!-- /.content-header -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- .card-body -->
                    {{ Form::open(['url' => URL::to('health-record/vaccine-store'), 'files' => true, 'class' => 'multiple-form-submit']) }}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" required class="form-control" placeholder="Date of Vaccine Record" name="treatment_date" value="{{ old('treatment_date') }}" max="{{ date('Y-m-d') }}">
                                </div>
                            </div>
                        </div>
