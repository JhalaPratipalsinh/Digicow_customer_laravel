...
$breadcrumb .= '<li class="breadcrumb-item active">Vaccine List</li>';
@endphp
<x-backend-breadcrumb title="Vaccine List" breadcrumb="{{$breadcrumb}}" />
<!-- /.content-header -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="vaccine-list" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Cow Name</th>
                                    <th>Vaccine</th>
...
<script src="{{ asset('assets/dist/js/vaccine.js') }}"></script>
@endsection
