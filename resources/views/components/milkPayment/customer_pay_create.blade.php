...
@section('contents')
    ...
    @php
        ...
        $breadcrumb .= '<li class="breadcrumb-item"><a href="">Register New Milk Payment Customer</a></li>';
        $breadcrumb .= '<li class="breadcrumb-item active">Create</li>';
    @endphp
    <x-backend-breadcrumb title="Register New Milk Payment Customer" breadcrumb="{{ $breadcrumb }}" />
    <!-- /.content-header -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- .card-body -->
                        {{ Form::open(['url' => URL::to('milk-payment/customer-pay-store'), 'files' => true, 'class' => 'multiple-form-submit']) }}
