...
$breadcrumb .= '<li class="breadcrumb-item"><a href="">Register New Milk Sales Co-Operative</a></li>';
$breadcrumb .= '<li class="breadcrumb-item active">Create</li>';
@endphp
<x-backend-breadcrumb title="Register New Milk Sales Co-Operative" breadcrumb="{{ $breadcrumb }}" />
<!-- /.content-header -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- .card-body -->
                    {{ Form::open(['url' => URL::to('milk-sales/coop-store'), 'files' => true, 'class' => 'multiple-form-submit']) }}
