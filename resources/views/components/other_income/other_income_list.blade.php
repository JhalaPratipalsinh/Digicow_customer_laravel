...
$breadcrumb .= '<li class="breadcrumb-item active">Other Income List</li>';
@endphp
<x-backend-breadcrumb title="Other Income List" breadcrumb="{{$breadcrumb}}" />
<!-- /.content-header -->
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="otherIncome-list" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Amount</th>
...
<script src="{{ asset('assets/dist/js/other_income.js') }}"></script>
@endsection
